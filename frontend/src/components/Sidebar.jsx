...
const Sidebar = () => {
  ...
  return (
    <div className="w-[400px] h-full p-2 flex-col gap-2 text-white hidden lg:flex text-sm">
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 bg-[#242424] m-2 rounded font-bold flex flex-col items-start justify-start gap-1 pl-4 mt-4 text-[16px]">
